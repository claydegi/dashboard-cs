...
const WEBINAR_DATA = {
    ...
    'WEBINAR_BOSCHINI_BLEXO_EN': {
        ...
        subject_followup: 'The webinar recording is ready — Dr. Boschini, 18 Months of Blexo',
        link_followup: 'https://app.osseotouch.com/webinar-followup-boschini-en',
        ...
        cta_followup_label: 'WATCH THE WEBINAR',
        cta_followup_sub: 'Full recording + details on the Blexo Kit',
...
const WEBINAR_I18N = {
    ...
    en: {
        ...
        grazie_guardato: 'Your webinar recording is now available',
        ...
        speranza_utile_recorded_prefix: 'The recording of',
        speranza_utile_recorded_suffix: 'that you registered for is now ready to watch.',
        vuole_seguito_live: 'Would you like to take the next step?',
        vuole_seguito_recorded: 'Click below to watch the full webinar on our platform:',
...
async function syncSutureFromOdoo() {
    ...
    try {
        ...
        // 3) Impegnato da sale.order.line — TUTTI gli ordini NON annullati, non completamente consegnati.
        //    Regola business: ogni ordine inserito contribuisce al fabbisogno a prescindere dallo stato
        //    (draft = preventivo, sent = preventivo inviato, sale = confermato). Esce solo lo stato 'cancel'.
        ...
        const solLines = await odooExecute(uid, 'sale.order.line', 'search_read',
            [[['product_id', 'in', productIds], ['order_id.state', '!=', 'cancel']]],
...
app.get('/api/crm/migration-stats', requireAdmin, async (req, res) => {
    try {
        ...
        console.error('[CRM Migration Stats]', err);
...
const ZOOM_WEBINAR_IDS = {
    ...
    'WEBINAR_BOSCHINI_BLEXO': '87698064659',
...
app.get('/webinar-boschini-followup', (req, res) => {
...
// Template completo via suturePortalRenderer.renderPortaleHTML (sub-task 3.2, 2026-04-24)
...
<p>Per assistenza: <a href="mailto:contact@osseotouch.com">contact@osseotouch.com</a></p>
        ...
        const mode = (req.query && req.query.mode === 'rep') ? 'rep' : 'cliente';
        const html = suturePortalRenderer.renderPortaleHTML(data, mode);
